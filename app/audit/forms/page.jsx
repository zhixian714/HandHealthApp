...
import { ChevronLeft, Droplets, Syringe, ShieldCheck, Ruler } from "lucide-react";
    ...
    >
      ...
      <div className="w-full max-w-md pb-16" style={{ color: "#16242C" }}>
        <div className="px-5 pt-5 pb-6">
          <Link href="/audit" className="flex items-center gap-1 text-sm mb-3" style={{ color: "#5B6B72" }}>
            <ChevronLeft size={16} /> 返回感控稽核首頁
          </Link>
